...
i18n.use(initReactI18next).init({
  resources: {
    en: { appointment: appointmentEN, staff: staffEN, settings: settingsEN, service: serviceEN, common: commonEN, workspace: workspaceEN },
    vi: { appointment: appointmentVI, staff: staffVI, settings: settingsVI, service: serviceVI, common: commonVI, workspace: workspaceVI },
  },
